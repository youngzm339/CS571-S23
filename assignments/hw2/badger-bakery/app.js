...
function calculateSubtotal() {
	...
	const subtotal = bagelQuantity * 1.5 + donutQuantity * 1.0 + muffinQuantity * 2.0 + pieQuantity * 4.5 + cakeQuantity * 7.0;
	return subtotal;
}
...
function calculateSalesTax() {
	...
	state_tax = document.getElementById("stateTax").value;
	return roundMoney(SALES_TAX[state_tax]);
}
...
document.getElementById("btnCheckout").addEventListener("click", () => {
	alert("Your totoal is $" + calculateSubtotal() * (1.0 + calculateSalesTax()))
});